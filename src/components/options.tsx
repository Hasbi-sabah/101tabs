                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent
                        side='right'
                        className='max-w-[150px] bg-transparent backdrop-blur-md'
                      >
                        <p>
                          Set the maximum number of tabs you want to keep open
                          per window.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent
                        side='right'
                        className='max-w-[200px] bg-transparent pr-2 backdrop-blur-md'
                      >
                        <p>
